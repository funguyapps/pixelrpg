...
{
    [Serializable]
    public class AirDragon : IPixel
    {
        public override string Name => "Air Dragon";
        ...
        [NonSerialized()]
        private IMove move4 = new Tornado();
        public override IMove Move4 { get => move4; set { move4 = value; } }


        public override string TextureStr => "Graphics\\Pixels\\Air\\airDragon";
