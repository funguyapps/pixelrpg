...
namespace PixelRPG.Pixels.Air
{
    ...
    public class Drone : IPixel
    {
        ...
        [NonSerialized()]
        private IMove move2 = new Airstrike();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Air\\drone"; } }
