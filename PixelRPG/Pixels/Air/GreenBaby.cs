...
{
    [Serializable]
    public class GreenBaby : IPixel
    {
        public override string Name => "Green Baby";
        ...
        public override IPixel NextForm { get => new GreenBoy(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Air\\greenbaby"; } }
