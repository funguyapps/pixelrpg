...
{
    [Serializable]
    public class Nimbaby : IPixel
    {
        public override string Name => "Nimbaby";

        private bool active = true;
        public override bool Active { get => active; set => active = value; }

        private int evolveLevel = 5;
        ...
        public override IPixel NextForm { get => new Nimbus(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Air\\Nimbaby"; } }
