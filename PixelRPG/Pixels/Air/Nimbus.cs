...
namespace PixelRPG.Pixels.Air
{
    ...
    public class Nimbus : IPixel
    {
        ...
        [NonSerialized()]
        private IMove move3 = new Lightning();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Air\\Nimbus"; } }
