...
{
    [Serializable]
    public class Wisbaby : IPixel
    {
        public override string Name => "Wisbaby";
        ...
        public override IPixel NextForm { get => new Wisp(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Air\\wisbaby"; } }
