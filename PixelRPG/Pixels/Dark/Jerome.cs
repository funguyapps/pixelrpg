...
{
    [Serializable]
    public class Jerome : IPixel
    {
        public override string Name => "Jerome";

        private bool active = true;
        public override bool Active { get => active; set => active = value; }

        private int evolveLevel = 999999;
        ...
        public override ElementType Element { get { return ElementType.Dark; } }
        ...
        public override int XPValue { get => level * 20; }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Dark\\jerome"; } }
