...
{
    [Serializable]
    public class Seanusy : IPixel
    {
        public override string Name => "Seanusy";
        ...
        [NonSerialized()]
        private IMove move2 = new Enrage(); // new Storm();
        ...
        public override string TextureStr => "Graphics\\Pixels\\Dark\\seanusy";
