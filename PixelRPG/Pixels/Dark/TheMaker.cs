...
{
    [Serializable]
    public class TheMaker : IPixel
    {
        public override string Name => "The Maker";
        ...
        [NonSerialized()]
        private IMove move2 = new Enrage(); // new Deluge();
        ...
        public override string TextureStr => "Graphics\\Pixels\\Dark\\the_maker";
