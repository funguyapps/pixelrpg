...
{
    [Serializable]
    public class Tytus : IPixel
    {
        public override string Name => "Tytus";
        ...
        [NonSerialized()]
        private IMove move2 = new Enrage(); //new Conflagration();
        ...
        [NonSerialized()]
        private IMove move4 = null; // new Enrage();
        public override IMove Move4 { get => move4; set { move4 = value; } }


        public override string TextureStr => "Graphics\\Pixels\\Dark\\tytus";
