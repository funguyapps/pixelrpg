...
{
    [Serializable]
    public class YourMaker : IPixel
    {
        public override string Name => "Your Maker";
        ...
        public override int XPValue => level * 10;
        ...
        public override string TextureStr => "Graphics\\Pixels\\Dark\\your_maker";
