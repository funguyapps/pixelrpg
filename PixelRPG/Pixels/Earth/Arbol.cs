...
{
    [Serializable]
    public class Arbol : IPixel
    {
        public override string Name => "Arbol";
        ...
        [NonSerialized()]
        private IMove move3 = new CuttingRoots();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\arbol"; } }
