...
{
    [Serializable]
    public class BladeBlossom : IPixel
    {
        public override string Name => "Blade Blossom";
        ...
        [NonSerialized()]
        private IMove move1 = new Cut();
        public override IMove Move1 { get { return move1; } set { move1 = value; } }

        [NonSerialized()]
        private IMove move2 = new Bladestorm();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\bladeblossom"; } }
