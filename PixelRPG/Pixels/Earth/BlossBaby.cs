...
{
    [Serializable]
    public class BlossBaby : IPixel
    {
        public override string Name => "Blossbaby";
        ...
        public override IPixel NextForm { get => new BladeBlossom(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\blossbaby"; } }
