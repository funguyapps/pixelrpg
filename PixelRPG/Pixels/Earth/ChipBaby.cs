...
{
    [Serializable()]
    class ChipBaby : IPixel
    {
        public override string Name => "Chip Baby";
        ...
        public override IPixel NextForm { get => new Chippy(); set { return; } }
        ...
        [NonSerialized()]
        private IMove move1 = new Pounce();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\chippyBaby"; } }
