...
namespace PixelRPG.Pixels.Earth
{
    ...
    class Chippy : IPixel
    {
        public override string Name => "Chippy";
        ...
        [NonSerialized()]
        private IMove move1 = new Scratch();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\chippy"; } }
