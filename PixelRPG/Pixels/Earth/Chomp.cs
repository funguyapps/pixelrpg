...
{
    [Serializable]
    public class Chomp : IPixel
    {
        public override string Name => "Chomp";
        ...
        [NonSerialized()]
        private IMove move2 = new CuttingRoots();
        public override IMove Move2 { get { return move2; } set { move2 = value; } }

        [NonSerialized()]
        private IMove move3 = new HealingGrowth();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\chomp"; } }
