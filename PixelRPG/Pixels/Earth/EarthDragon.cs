...
{
    [Serializable]
    public class EarthDragon : IPixel
    {
        public override string Name => "Earth Dragon";
        ...
        [NonSerialized()]
        private IMove move4 = new Harden();
        public override IMove Move4 { get => move4; set { move4 = value; } }


        public override string TextureStr => "Graphics\\Pixels\\Earth\\earthDragon";
