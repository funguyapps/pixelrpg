...
{
    [Serializable()]
    public class EarthDragonling : IPixel
    {
        public override string Name => "Earth Dragonling";
        ...
        public override IPixel NextForm { get => new EarthDragon(); set { return; } }
        ...
        public override string TextureStr => "Graphics\\Pixels\\Earth\\earthDragonling";
