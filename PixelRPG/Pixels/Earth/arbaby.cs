...
{
    [Serializable]
    public class Arbaby : IPixel
    {
        public override string Name => "Arbaby";
        ...
        public override IPixel NextForm { get => new Arbol(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Earth\\arbaby"; } }
