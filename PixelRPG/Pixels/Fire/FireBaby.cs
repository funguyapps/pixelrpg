...
{
    [Serializable]
    public class FireBaby : IPixel
    {
        public override string Name => "Fire Baby";
        ...
        public override IPixel NextForm { get => new FireDragonling(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Fire\\fireBaby"; } }
