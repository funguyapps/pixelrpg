...
{
    [Serializable]
    public class FireDragonling : IPixel
    {
        public override string Name => "Fire Dragonling";
        ...
        public override IPixel NextForm { get => new FireDragon(); set { return; } }
        ...
        public override string TextureStr => "Graphics\\Pixels\\Fire\\fireDragonling";
