...
{
    [Serializable]
    public class Flamander : IPixel
    {
        public override string Name => "Flamander";
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Fire\\flamander"; } }
