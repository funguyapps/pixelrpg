...
{
    [Serializable]
    public class FoxBaby : IPixel
    {
        public override string Name => "Fox Baby";
        ...
        public override IPixel NextForm { get => new FlameFox(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Fire\\foxbaby"; } }
