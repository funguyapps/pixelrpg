...
{
    [Serializable]
    public class Ignis : IPixel
    {
        public override string Name => "Ignis";
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Fire\\ignis"; } }
