...
{
    [Serializable]
    public class Salababy : IPixel
    {
        public override string Name => "Salababy";
        ...
        public override IPixel NextForm { get => new Flamander(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Fire\\salababy"; } }
