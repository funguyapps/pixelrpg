...
{
    [Serializable]
    public class Crababy : IPixel
    {
        public override string Name => "Clambaby";
        ...
        public override IPixel NextForm { get => new ClampCrab(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Water\\crababy"; } }
