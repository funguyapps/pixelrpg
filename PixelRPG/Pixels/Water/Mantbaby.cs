...
{
    [Serializable]
    public class Mantbaby : IPixel
    {
        public override string Name => "Mantbaby";
        ...
        public override IPixel NextForm { get => new Manta(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Water\\mantbaby"; } }
