...
{
    [Serializable]
    public class Narbaby : IPixel
    {
        public override string Name => "Narbaby";
        ...
        public override IPixel NextForm { get => new Narwhally(); set { return; } }
        ...
        [NonSerialized()]
        // WIND CUTTER
        private IMove move2 = new Droplet();
        public override IMove Move2 { get { return move2; } set { move2 = value; } }

        [NonSerialized()]
        private IMove move3 = new Stream();
