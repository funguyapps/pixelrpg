...
{
    [Serializable]
    public class Spoubaby : IPixel
    {
        public override string Name => "Spoubaby";
        ...
        public override IPixel NextForm { get => new Spout(); set { return; } }
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Water\\spoubaby"; } }
