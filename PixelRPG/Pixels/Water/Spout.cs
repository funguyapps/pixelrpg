...
namespace PixelRPG.Pixels.Water
{
    ...
    public class Spout : IPixel
    {
        ...
        [NonSerialized()]
        // WIND CUTTER
        private IMove move2 = new Harden();
        public override IMove Move2 { get { return move2; } set { move2 = value; } }

        [NonSerialized()]
        private IMove move3 = new Deluge();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Water\\spout"; } }
