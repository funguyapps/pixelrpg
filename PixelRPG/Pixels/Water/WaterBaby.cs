...
{
    [Serializable]
    public class WaterBaby : IPixel
    {
        public override string Name => "Water Baby";
        ...
        public override IPixel NextForm { get => new WaterDragonling(); set { return; } }
        ...
        [NonSerialized()]
        // GUST
        private IMove move1 = new Stream();
        ...
        public override string TextureStr { get { return "Graphics\\Pixels\\Water\\waterBaby"; } }
