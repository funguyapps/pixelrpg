...
{
    [Serializable]
    public class WaterDragon : IPixel
    {
        public override string Name => "Water Dragon";
        ...
        public override string TextureStr => "Graphics\\Pixels\\Water\\waterDragon";
