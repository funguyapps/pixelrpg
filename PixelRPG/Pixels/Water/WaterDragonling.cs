...
{
    [Serializable]
    public class WaterDragonling : IPixel
    {
        public override string Name => "Water Dragonling";
        ...
        public override IPixel NextForm { get => new WaterDragon(); set { return; } }
        ...
        [NonSerialized()]
        private IMove move1 = new Torrent();
        public override IMove Move1 { get => move1; set { move1 = value; } }

        [NonSerialized()]
        private IMove move2 = new Deluge();
        ...
        public override string TextureStr => "Graphics\\Pixels\\Water\\waterDragonling";
